...
import type { NativeMethods, NativeSyntheticEvent, TargetedEvent, ViewProps, ViewStyle } from 'react-native';
...
declare module '@react-native-segmented-control/segmented-control' {
  ...
  declare const SegmentedControlBase: Constructor<NativeMethods> & typeof SegmentedControlComponent;
