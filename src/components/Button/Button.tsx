...
const Button: React.FC<Props> = (
  ...
  return (
    <TouchableOpacity
      ...
      onPress={onPress}
    >
      {iconLeft && React.createElement(iconLeft, { color: colors.button[variant].text, height: 34, width: 34 })}
      <Text
        align={textAlign}
        variant={textVariant}
      ...
      {iconRight && React.createElement(iconRight, { color: colors.button[variant].text, height: 34, width: 34 })}
    </TouchableOpacity>
  );
};
